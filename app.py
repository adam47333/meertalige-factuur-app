...
# Vertalingen voor labels, voeg hier andere talen toe
translations = {
    'nl': {
    ...
    'fr': {
        ...
        'save_company': 'Sauvegarder les infos société',
        'clear_company': 'Effacer les infos société',
    ...
    'it': {
        ...
        'save_company': 'Salva info azienda',
        'clear_company': 'Cancella info azienda',
    ...
    'es': {
        ...
        'save_company': 'Guardar datos empresa',
        'clear_company': 'Borrar datos empresa',
    ...
    'pt': {
        ...
        'save_company': 'Guardar informações da empresa',
        'clear_company': 'Apagar informações da empresa',
        'upload_logo': 'Carregar o seu logo (opcional)',
        'street': 'Rua e número',
        'postcode': 'Código postal',
        'city': 'Cidade',
        'country': 'País',
